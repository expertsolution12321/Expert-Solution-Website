...
function Popup({ onClose, onSubmit }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg w-full max-w-md p-6 relative shadow-lg animate-fadeIn">
        <button
        ...
        <h2 className="text-xl font-semibold text-gray-800 mb-4 text-center">
          Welcome! to Trip Management System
        </h2>
        <form onSubmit={handleSubmit} className="flex flex-col">
          ...
          <button
            type="submit"
            className="bg-blue-500 hover:bg-blue-600 text-white rounded-lg py-2 px-4 transition-colors"
          >
            Submit
          </button>
        </form>
